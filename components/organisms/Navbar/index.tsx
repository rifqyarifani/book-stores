            ...
            <span className="sm:ml-3">
              {auth?.id ? (
                <button
                  ...
                  className="nav-link inline-flex items-center lg:-ml-3 md:-mt-5 -mt-2 lg:mt-0 py-2 text-sm font-semibold"
                >
                  Keluar
                </button>
              ) : (
                <Link
                  href="/signin"
                  className="inline-flex items-center px-3 md:-ml-3 lg:ml-0 py-2 text-sm font-semibold text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Masuk
                </Link>
              )}
