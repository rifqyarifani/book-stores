            ...
            <tr key="1" className=" h-8">
              ...
              <td className=" border border-slate-700 rounded-md text-center">
                <div className=" flex justify-center gap-x-4">
                  <Link className=' nav-link page-scroll' href="/admin/transactions/detail">
                    <BsInfoCircle className=" text-2xl text-green-800" />
                  </Link>
                  <Link className=' nav-link page-scroll' href="/admin/transactions/edit">
                    <AiOutlineEdit className=" text-2xl text-yellow-600" />
                  </Link>
                  <Link className=' nav-link page-scroll' href="/admin/transactions/delete">
